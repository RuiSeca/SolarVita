...
class SupporterProfileService {
  ...
  Future<PrivacySettings?> getSupporterPrivacySettings(String supporterId) async {
    try {
  ...
  Future<UserProgress?> getSupporterProgress(String supporterId, PrivacySettings privacy) async {
    try {
  ...
  Future<HealthData?> getSupporterHealthData(String supporterId, PrivacySettings privacy) async {
    try {
      if (!privacy.showWorkoutStats) {
  ...
  Future<Map<String, List<Map<String, dynamic>>>?> getSupporterDailyMeals(String supporterId, PrivacySettings privacy) async {
    try {
  ...
  Future<Map<String, dynamic>?> getSupporterWeeklyData(String supporterId, PrivacySettings privacy) async {
    try {
      if (!privacy.showWorkoutStats) {
        return null;
      }
  ...
  Future<List<Achievement>?> getSupporterAchievements(String supporterId, PrivacySettings privacy) async {
    try {
  ...
  Future<void> shareHealthDataWithSupporters(HealthData healthData, UserProgress progress) async {
    try {
      final currentUser = _auth.currentUser;
  ...
  Future<SupporterProfileData> getSupporterProfileData(String supporterId) async {
    try {
