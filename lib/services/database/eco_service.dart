...
class EcoService {
  ...
  static double calculateMealCarbonSaved(
    String mealCategory, {
    int? calories,
  ...
  static double _calculateTransportCarbon(
    String activity,
    Map<String, dynamic>? metadata,
  ) {
  ...
  static double _calculateFoodCarbon(
    String activity,
    Map<String, dynamic>? metadata,
  ) {
    switch (activity) {
  ...
  static double _calculateEnergyCarbon(
    String activity,
    Map<String, dynamic>? metadata,
  ) {
    switch (activity) {
  ...
  static double _calculateWasteCarbon(
    String activity,
    Map<String, dynamic>? metadata,
  ) {
    switch (activity) {
  ...
  static double _calculateConsumptionCarbon(
    String activity,
    Map<String, dynamic>? metadata,
  ) {
    switch (activity) {
  ...
  Future<String> logMealActivity(
    ...
    final carbonSaved = calculateMealCarbonSaved(
      mealCategory,
      calories: calories,
    ...
    if (carbonSaved <= 0) {
      throw Exception(
        'This meal choice doesn\'t provide significant carbon savings',
      );
    }

    final activityName = isCustomMeal
        ? 'homeCooking'
        : _getMealActivityName(mealCategory);
    final displayName =
        mealName ?? _getMealDisplayName(mealCategory, isCustomMeal);
  ...
  static String _getMealDisplayName(String category, bool isCustomMeal) {
    ...
    switch (category.toLowerCase()) {
      ...
      case 'side':
        return 'Side Dish';
      case 'starter':
        return 'Starter/Appetizer';
      case 'dessert':
        return 'Dessert';
      default:
        return '${category[0].toUpperCase()}${category.substring(1)} Meal';
    }
  }
  ...
  static double calculateTransportationCarbonSaved({
    required int steps,
    ...
    final activeMinutesCarbonSaved =
        activeMinutes * 0.01; // 0.01 kg CO₂ per active minute
