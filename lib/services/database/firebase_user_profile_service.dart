...
class FirebaseUserProfileService {
  static final FirebaseUserProfileService _instance =
      ...
      if (followingDoc.exists) {
        ...
        batch.set(
          _firestore
              ...
              .collection(_followingCollection)
              .doc(targetUserId),
          {'followedAt': FieldValue.serverTimestamp(), 'userId': targetUserId},
        );
        ...
        batch.set(
          _firestore
              ...
              .collection(_followersCollection)
              .doc(currentUserId),
          {'followedAt': FieldValue.serverTimestamp(), 'userId': currentUserId},
        );
      }
