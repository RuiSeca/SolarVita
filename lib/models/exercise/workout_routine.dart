...
class WorkoutRoutine {
  ...
  factory WorkoutRoutine.empty(String name) {
    ...
    final weeklyPlan = days
        .map((day) => DailyWorkout(dayName: day, exercises: []))
        .toList();
...
class RoutineManager {
  ...
  Map<String, dynamic> toJson() {
    return {'routines': routines.map((routine) => routine.toJson()).toList()};
  }
