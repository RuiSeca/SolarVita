...
class Tribe {
  ...
  factory Tribe.fromFirestore(DocumentSnapshot doc) {
    ...
    return Tribe(
      ...
      category: TribeCategory.values[(data['category'] is int ? data['category'] : int.tryParse(data['category']?.toString() ?? '0')) ?? 0],
      customCategory: data['customCategory'],
      visibility: TribeVisibility.values[(data['visibility'] is int ? data['visibility'] : int.tryParse(data['visibility']?.toString() ?? '0')) ?? 0],
