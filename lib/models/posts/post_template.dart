...
import '../social/social_post.dart';
  ...
  static List<PostTemplate> getWeeklyWinsTemplates() {
    return [
      ...
      PostTemplate(
        ...
        promptText:
            'Nutrition win of the week: {achievement} 🥗\n\nHow it felt: {feeling}\n\nTip for others: {tip}',
        suggestedContent: [
  ...
  static List<PostTemplate> getGratitudeTemplates() {
    return [
      PostTemplate(
        ...
        promptText:
            'Today I\'m grateful for: {gratitude_1}, {gratitude_2}, and {gratitude_3} 🙏\n\nWhy: {reason}\n\nSpread the gratitude: {call_to_action}',
        suggestedContent: [
