...
class TransportationDetailsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TransportationDetailsScreen> createState() =>
      _TransportationDetailsScreenState();
}

class _TransportationDetailsScreenState
    extends ConsumerState<TransportationDetailsScreen> {
  @override
  ...
  Widget _buildAchievementsSection(
    ...
    final achievements = _calculateTransportationAchievements(
      steps,
      activeMinutes,
    );
  ...
  Widget _buildEnvironmentalImpactSection(
    ...
    final bottlesSaved = (carbonSavings / 0.2).round();
    final treesEquivalent = (carbonSavings / 22).toStringAsFixed(
      1,
    ...
    final tips = [
      {
        ...
        'description':
            'Choose walking for trips under 1km to maximize health and environmental benefits.',
        'color': Colors.green,
      },
      {
        'icon': Icons.directions_bike,
        ...
        'description':
            'Cycling is perfect for 1-5km trips, saving time while staying eco-friendly.',
        'color': Colors.blue,
      },
      {
        'icon': Icons.directions_bus,
        ...
        'description':
            'For longer distances, public transport reduces individual carbon footprint significantly.',
        'color': Colors.orange,
      },
      {
        'icon': Icons.group,
        ...
        'description':
            'When driving is necessary, sharing rides can reduce emissions per person.',
        'color': Colors.purple,
      },
    ];
  ...
  List<Map<String, dynamic>> _calculateTransportationAchievements(
    int steps,
    int activeMinutes,
  ) {
    ...
    if (carbonSaved >= 1.0) {
      achievements.add({
        ...
        'title': 'Carbon Saver',
        'description':
            'Saved ${carbonSaved.toStringAsFixed(1)}kg CO₂ by walking!',
      });
    }
