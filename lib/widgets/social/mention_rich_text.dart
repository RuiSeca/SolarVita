...
class MentionUtils {
  ...
  static List<MentionInfo> parseMentions(String text, {List<MentionableUser>? knownUsers}) {
  ...
  static List<MentionInfo> validateMentions(String text, List<MentionInfo> mentions) {
    ...
    for (final mention in mentions) {
      ...
      if (mention.startIndex >= 0 && 
          ...
          text.substring(mention.startIndex, mention.endIndex) == mention.mentionText) {
