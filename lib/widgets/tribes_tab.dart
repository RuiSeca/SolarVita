...
class TribesTab extends ConsumerStatefulWidget {
  const TribesTab({super.key});

  @override
  ConsumerState<TribesTab> createState() => _TribesTabState();
}

class _TribesTabState extends ConsumerState<TribesTab>
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return _buildModernTribeCard(filteredTribes[index], isMyTribe: true);
          },
        );
      },
    );
          ...
          child: StreamBuilder<List<Tribe>>(
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemCount: filteredTribes.length,
                itemBuilder: (context, index) {
                  return _buildModernTribeCard(filteredTribes[index], isMyTribe: false);
                },
              );
            },
          ),
  ...
  Widget _buildModernTribeCard(Tribe tribe, {required bool isMyTribe}) {
    final theme = Theme.of(context);
